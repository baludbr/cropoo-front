...
{products!=null && <>
  <marquee>
  <h2>Total Products: {products.length} </h2></marquee>
      ...
      <Table sx={{ minWidth: 650}} aria-label="simple table">
        <TableHead>
          <TableRow sx={{backgroundColor:'blue',color:'white !important'}}>
            ...
            <TableCell align="right">Seller Phone No</TableCell>
            <TableCell align="right">Crop</TableCell>
            <TableCell align="right">Godown Details</TableCell>
        ...
        {products.map((product)=>{
            ...
            >
              ...
              <TableCell align="right">{product.mail}</TableCell>
              <TableCell align="right">{product.phonenum}</TableCell>
              <TableCell align="right">{product.croptype}</TableCell>
